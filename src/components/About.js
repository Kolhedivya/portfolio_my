...
function About() {
    return (
        <motion.section
            id="about"
            className="min-h-screen pt-24 flex flex-col justify-center items-center bg-gradient-to-r from-ink via-prussian to-dusk text-center text-alabaster px-4 sm:px-6"
        ...
        >
            ...
            {/* Name & Title */}
            <h1 className="text-3xl sm:text-5xl font-bold mb-2">Divya Kolhe</h1>
            <h2 className="text-lg sm:text-xl text-lavender mb-4">ReactJS / UI Developer</h2>
            <p className="text-sm sm:text-base max-w-md sm:max-w-xl mb-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 mb-8">
                <a
                    href="#featured"
                    className="flex flex-wrap justify-center gap-2 sm:gap-4 mb-6 bg-alabaster text-ink px-6 py-3 rounded-lg font-semibold flex items-center gap-2 hover:bg-lavender transition"
                >
                    <MdWork /> View My Work
                </a>
                <a
                    href="#contact"
                    className="flex flex-wrap justify-center gap-2 sm:gap-4 mb-6 bg-lavender text-ink px-6 py-3 rounded-lg font-semibold flex items-center gap-2 hover:bg-alabaster transition"
                >
                ...
                <a
                    href="/resume.pdf"
                    download
                    className="flex flex-wrap justify-center gap-2 sm:gap-4 mb-6 bg-prussian text-alabaster px-6 py-3 rounded-lg font-semibold flex items-center gap-2 hover:bg-dusk transition"
                >
            ...
            {/* Social Icons */}
            <div className="flex gap-4 sm:gap-6 text-xl sm:text-2xl text-lavender mb-6">
